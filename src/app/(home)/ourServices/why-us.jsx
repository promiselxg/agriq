          ...
          <div className="pt-20 pb-10">
            <div className="flex gap-5 ">
              ...
              <div className="flex items-center flex-col">
                <h1 className="text-3xl justify-start flex text-left w-full mt-[60px] mb-5 font-extrabold text-[#212529]">
                  Why Choose AgriQ?
                </h1>
                <ul>
                  <li className="flex gap-5 py-3">
                    <span className="w-[45px] h-[40px] rounded-[50%] text-2xl bg-[green] text-white flex items-center justify-center text-center">
                      <FiCheck />
                    </span>
                    <span>
                  ...
                  <li className="flex gap-5 py-3">
                    <span className="w-[45px] h-[40px] rounded-[50%] text-2xl bg-[#C5CE38] text-white flex items-center justify-center text-center">
                      <FiCheck />
                    </span>
                    <span>
                  ...
                  <li className="flex gap-5 py-3">
                    <span className="w-[45px] h-[40px] rounded-[50%] text-2xl bg-[#EEC044] text-white flex items-center justify-center text-center">
                      <FiCheck />
                    </span>
                    <span>
                      <h1 className="text-[20px] font-bold capitalize leading-normal">
                  ...
                  <li className="flex gap-5 py-3">
                    <span className="w-[45px] h-[40px] rounded-[50%] text-2xl bg-[#F04C23] text-white flex items-center justify-center text-center">
                      <FiCheck />
                    </span>
                    <span>
                      <h1 className="text-[20px] font-bold capitalize leading-normal">
